...
class AspectFrequencyCalculation:
    def calculateAspectFrequency(self, listTweetSentimentClassification, sinceFrom, untilTo):
        ...
        tweet = {
            "sinceFrom"         : sinceFrom,
            "untilTo"           : untilTo,
            "aspectPositive"    : listTweetPositiveSentiment,
            "aspectNegative"    : listTweetNegativeSentiment
        }
